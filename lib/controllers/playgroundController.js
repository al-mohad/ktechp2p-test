...
exports.firebaseDB = exports.testUpload = exports.sendSMS = exports.getotp = exports.sendOTP = exports.getRepos = exports.playingPlayground = void 0;
...
const firebaseDB = async (req, res, next) => {
    const firebaseController = new firebaseController_1.default();
    await firebaseController.test().then((v) => {
        res.send(200).json({ 'success': 'Records inserted' });
    });
};
